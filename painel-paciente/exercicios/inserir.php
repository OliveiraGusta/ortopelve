...
$res = $pdo->prepare("INSERT into exercicios_pacientes (nome_exercicio, repeticoes, series, obs, id_paciente, id_medico) values (:nome_exercicio, :repeticoes, :series, :obs, :id_paciente, :id_medico)");
