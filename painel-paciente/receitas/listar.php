...
$res_paciente = $pdo->query("SELECT * from pacientes where email = '$email_paciente' and medico_resp = '$nome_medico'");
...
$res = $pdo->query("SELECT * from consultas where medico = '$id_medico' and paciente = '$id_paciente' and receita = 'sim' order by hora asc");
