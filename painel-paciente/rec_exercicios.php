...
<span class="text-muted">Listagem de todos os exercicios recomendados pelo seu Profissional da Saúde</span><br>
...
<div class="modal" id="modal-realizar-exercicio" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
            ...
            <p>Deseja realmente fazer a marcação desse exercicio?<br></p>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal" id="btn-cancelar-exercicio">Cancelar</button>
				<form method="post">
