...
<span class="text-muted">Aqui você tem todo controle das consultas já agendadas.</span><br>
...
<div class="modal" id="modal-prescricao" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
              <span class="text-muted">Lembre-se que o limite por campo é de no máximo <span class="text-danger"> 500 caracteres.</span></span><br>
                ...
                <form method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="civil" placeholder="Estado Civil"
