<?php $pagina = 'atendimentos'; ?>
<h4>Área de Serviços</h4>
<span class="text-muted">Aqui você cadastra todos os serviços e seus tipos de atendimentos.</span><br>
		<br>
    ...
    <div class="col-md-6 col-sm-12">
        ...
        <div class="float-right mr-4">
            <form id="frm" class="form-inline my-2 my-lg-0" method="post">
                ...
                <input class="form-control form-control-sm mr-sm-2" type="search" placeholder="Descrição"
            ...
            <div class="modal-body">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="campo_antigo" name="campo_antigo" value="<?php echo @$descricao ?>"
                            required>
                        ...
                        <input type="text" class="form-control" id="descricao" placeholder="Insira a Descrição"
                            name="descricao" value="<?php echo @$descricao ?>" required>
                    </div>
