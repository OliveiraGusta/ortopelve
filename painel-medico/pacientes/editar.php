...
$res = $pdo->prepare("UPDATE pacientes set rg = :rg, telefone = :telefone, email  = :email, data_nasc =  :data_nasc, idade = :idade, civil = :civil, sexo_identifica = :sexo_identifica, identidade_genero = :identidade_genero, pronome_paciente = :pronome_paciente, endereco = :endereco, obs = :obs,peso = :peso,altura = :altura,imc = :imc,medico_old = :medico_old, medico_resp = :medico_resp, queixa_prin = :queixa_prin, antecedentes_pessoais = :antecedentes_pessoais, antecedentes_cirurgicos = :antecedentes_cirurgicos,antecedentes_familiares = :antecedentes_familiares,medicacoes = :medicacoes, antecedentes_urologicos = :antecedentes_urologicos, queixas_urinarias = :queixas_urinarias, perdas_aos_esforcos = :perdas_aos_esforcos, tipos_queixa_urina = :tipos_queixa_urina,perdas_esforcos = :perdas_esforcos, circunstancias_das_perdas = :circunstancias_das_perdas, funcao_sexual = :funcao_sexual, SHIM = :SHIM, antecedentes_neurologicos = :antecedentes_neurologicos, habitos_vida = :habitos_vida, uso_frequente = :uso_frequente, consumo_liquidos = :consumo_liquidos, cicatrizes = :cicatrizes, trofismo_genital = :trofismo_genital, trofismo_mmii = :trofismo_mmii, contracao_voluntaria = :contracao_voluntaria, musculos_acessorios = :musculos_acessorios,tonus_do_corpo_perinea = :tonus_do_corpo_perinea, tonus_do_eae = :tonus_do_eae, tonus_de_mmii = :tonus_de_mmii, forca_muscular = :forca_muscular, sensibilidade = :sensibilidade, corpo_perineal_urologia = :corpo_perineal_urologia, tonus_do_eae_urologia = :tonus_do_eae_urologia, puborretal_urologia = :puborretal_urologia, mmii_urologia = :mmii_urologia, fibrose_urologia = :fibrose_urologia, afa_urologia = :afa_urologia, perfect_urologia = :perfect_urologia, elasticidade_urologia = :elasticidade_urologia, coordenacao_urologia = :coordenacao_urologia, relaxamento_do_pr_a_manobra_de_evacuacao_urologia = :relaxamento_do_pr_a_manobra_de_evacuacao_urologia, pontos_dolorosos = :pontos_dolorosos, pergunta1_urologia = :pergunta1_urologia, pergunta2_urologia = :pergunta2_urologia, pergunta3_urologia = :pergunta3_urologia, pergunta4_urologia = :pergunta4_urologia, pergunta5_urologia = :pergunta5_urologia where id = :id ");
...
$res = $pdo->prepare("UPDATE ficha_proctologia set queixa_prin_proc = :queixa_prin_proc, antecedentes_pessoais_proc = :antecedentes_pessoais_proc, antecedentes_cirurgicos_proc = :antecedentes_cirurgicos_proc, antecedentes_familiares_proc = :antecedentes_familiares_proc,  historia_proctologica = :historia_proctologica, tempo_sintomas = :tempo_sintomas, tempo_ajuda = :tempo_ajuda, tempo_ajuda = :tempo_ajuda, sintomas_estado = :sintomas_estado, perdas_proc = :perdas_proc, frequencia_dos_acidentes = :frequencia_dos_acidentes, quantidade_da_perda = :quantidade_da_perda, protecoes_proc = :protecoes_proc, frequencia_evacuatoria = :frequencia_evacuatoria, manobra_evacuar = :manobra_evacuar, medicacoes_em_uso_proc = :medicacoes_em_uso_proc, partos_proc = :partos_proc, complicacoes_puerperais_proc = :complicacoes_puerperais_proc, cirurgias_ginecologicas_proc = :cirurgias_ginecologicas_proc, antecedentes_urologicos_proc = :antecedentes_urologicos_proc, habitos_vida_proc = :habitos_vida_proc, uso_frequente_proc = :uso_frequente_proc, restricao_do_consumo_de_liquidos_proc = :restricao_do_consumo_de_liquidos_proc, renda_familiar = :renda_familiar, cicatrizes_proc = :cicatrizes_proc, trofismo_perianal = :trofismo_perianal, trofismo_mmii_proc = :trofismo_mmii_proc, contracao_voluntaria_proc = :contracao_voluntaria_proc, abertura_vulvo_vaginal_proc = :abertura_vulvo_vaginal_proc, abertura_anal_proc = :abertura_anal_proc, apneia_proc = :apneia_proc, contracao_do_eae = :contracao_do_eae, corpo_perineal_proc = :corpo_perineal_proc, tonus_do_eae_proc = :tonus_do_eae_proc, puborretal_proc = :puborretal_proc, mmii_proc = :mmii_proc, fibrose_proc = :fibrose_proc, perfect_proc = :perfect_proc, afa_proc = :afa_proc, elasticidade_proc = :elasticidade_proc, coordenacao_proc = :coordenacao_proc, relaxamento_do_pr_a_manobra_de_evacuacao_proc = :relaxamento_do_pr_a_manobra_de_evacuacao_proc, pontos_dolorosos_proc = :pontos_dolorosos_proc, teste_de_esforco_proc = :teste_de_esforco_proc, reflexo_clitoriano_bulbocavernoso_proc = :reflexo_clitoriano_bulbocavernoso_proc, reflexo_ceigel_cremasterico = :reflexo_ceigel_cremasterico, marcha_proc = :marcha_proc, outros_dados_proc = :outros_dados_proc
where fkcpf = :fkcpf");
...
$res = $pdo->prepare("UPDATE ficha_uroginecologia set queixa_prin_urogine = :queixa_prin_urogine, antecedentes_pessoais_urogine = :antecedentes_pessoais_urogine, antecedentes_cirurgicos_urogine = :antecedentes_cirurgicos_urogine, antecedentes_familiares_urogine = :antecedentes_familiares_urogine, fase_de_enchimento_urogine = :fase_de_enchimento_urogine, fase_de_esvaziamento_urogine = :fase_de_esvaziamento_urogine, outros_fase_de_esvaziamento_urogine = :outros_fase_de_esvaziamento_urogine, sensibilidade_fase_de_esvaziamento_urogine = :sensibilidade_fase_de_esvaziamento_urogine, itu_fase_de_esvaziamento_urogine = :itu_fase_de_esvaziamento_urogine, perdas_urogine = :perdas_urogine, outras_circunstancias_perdas_urogine = :outras_circunstancias_perdas_urogine, perdas_durante_o_esforco_urogine = :perdas_durante_o_esforco_urogine, qualidade_da_perda_urinariao_urogine = :qualidade_da_perda_urinariao_urogine, quanto_tempo_iniciou_os_sintomas_urogine = :quanto_tempo_iniciou_os_sintomas_urogine, quanto_tempo_demorou_para_procurar_ajuda_medica_urogine = :quanto_tempo_demorou_para_procurar_ajuda_medica_urogine, desde_que_comecaram_os_sintomas_o_seu_estado_urogine = :desde_que_comecaram_os_sintomas_o_seu_estado_urogine,  frequencia_urinaria_urogine = :frequencia_urinaria_urogine, protecoes_urogine = :protecoes_urogine, numero_de_trocas_urogine = :numero_de_trocas_urogine, corpo_perineal_uroginecologia = :corpo_perineal_uroginecologia, tonus_do_eae_uroginecologia = :tonus_do_eae_uroginecologia, puborretal_uroginecologia = :puborretal_uroginecologia, mmii_uroginecologia = :mmii_uroginecologia, fibrose_uroginecologia = :fibrose_uroginecologia, afa_uroginecologia = :afa_uroginecologia, perfect_uroginecologia = :perfect_uroginecologia, elasticidade_uroginecologia = :elasticidade_uroginecologia, coordenacao_uroginecologia = :coordenacao_uroginecologia, relaxamento_do_pr_a_manobra_de_evacuacao_uroginecologia = :relaxamento_do_pr_a_manobra_de_evacuacao_uroginecologia,  pontos_dolorosos_uroginecologia = :pontos_dolorosos_uroginecologia, gestacoes_uroginecologia = :gestacoes_uroginecologia, partos_uroginecologia = :partos_uroginecologia, abortos_uroginecologia = :abortos_uroginecologia, parto1_uroginecologia = :parto1_uroginecologia, idade_materna1_uroginecologia = :idade_materna1_uroginecologia, peso_da_crianca1_uroginecologia = :peso_da_crianca1_uroginecologia, parto2_uroginecologia = :parto2_uroginecologia, idade_materna2_uroginecologia = :idade_materna2_uroginecologia, peso_da_crianca2_uroginecologia = :peso_da_crianca2_uroginecologia, parto3_uroginecologia = :parto3_uroginecologia, idade_materna3_uroginecologia = :idade_materna3_uroginecologia, peso_da_crianca3_uroginecologia = :peso_da_crianca3_uroginecologia, realizou_episiotomia_uroginecologia = :realizou_episiotomia_uroginecologia, forceps_uroginecologia = :forceps_uroginecologia, complicacoes_obstetricas_uroginecologia = :complicacoes_obstetricas_uroginecologia, data_da_ultima_menstruacao_uroginecologia = :data_da_ultima_menstruacao_uroginecologia, menopausa_uroginecologia = :menopausa_uroginecologia, metodo_anticoncepcional_uroginecologia = :metodo_anticoncepcional_uroginecologia, terapia_de_reposicao_hormonal_uroginecologia = :terapia_de_reposicao_hormonal_uroginecologia, complicacoes_ginecologicas_uroginecologia = :complicacoes_ginecologicas_uroginecologia, realizou_cirurgia_ginecologica_uroginecologia = :realizou_cirurgia_ginecologica_uroginecologia, auto_conhecimento_vaginal_uroginecologia = :auto_conhecimento_vaginal_uroginecologia, vida_sexual_uroginecologia = :vida_sexual_uroginecologia, perdeu_a_virgindade_uroginecologia = :perdeu_a_virgindade_uroginecologia, com_quem_perdeu_a_virgindade_uroginecologia = :com_quem_perdeu_a_virgindade_uroginecologia, experiencia_a_virgindade_uroginecologia = :experiencia_a_virgindade_uroginecologia, abuso_sexual_uroginecologia = :abuso_sexual_uroginecologia, permissao_abuso_sexual_uroginecologia = :permissao_abuso_sexual_uroginecologia, relato_abuso_sexual_uroginecologia = :relato_abuso_sexual_uroginecologia where fkcpf = :fkcpf");
