...
<h4>Área de Contas à Pagar </h4>
<span class="text-muted">Aqui você coloca suas despesas e custos para ser calculada no balanço final.</span><br><br>
            ...
            <div class="modal-body">
                ...
                <form id="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm mr-sm-2" type="date" name="data" id="data"
                            value="<?php echo $agora ?>">
                    </div>
