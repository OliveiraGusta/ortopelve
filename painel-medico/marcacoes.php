...
<span class="text-muted">Selecione o paciente, a data e digite o horario para realizar um agendamento</span><br>
		<br>
	...
	<div class="col-md-6 col-sm-12">
		<form id="frm" class="form-inline my-2 my-lg-0" method="post">
			...
			<select data-width="280px" class="form-control form-control-sm mr-2 sel2" name="cb-paciente" id="cb-paciente">
				...
				$res = $pdo->query("SELECT * from pacientes WHERE medico_resp = '$medico_resp'  order by nome asc ");
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<select class="form-control" id="atendimentos" name="atendimentos">
								...
								$res = $pdo->query("SELECT * from atendimentos WHERE email_med = '$email_med'  order by descricao asc");
								$dados = $res->fetchAll(PDO::FETCH_ASSOC);
