...
$cpf_func = $dados_excluir[0]['cpf'];


/*/BUSCAR O NOME DO FUNCIONÁRIO)
$res = $pdo->query("select * from medicos where cpf = '$funcionario'");
...
if($valor == ''){
	...
	$res->bindValue(":funcionario", $nome_usuario);
	$res->bindValue(":valor", $valor);
	$res->bindValue(":tesoureiro", $cpf_func);
	$res->bindValue(":nome_funcionario", $nome_medico);
