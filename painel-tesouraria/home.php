					...
					<div class="row">
						...
						<div class="col-7 col-md-8">
							<div class="numbers">
								...
								<p class="subtitulo-card"><small><small>R$ <?php echo @$total_entradas ?></small></small><p> 
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-7 col-md-8">
								<div class="numbers">
									...
									<p class="subtitulo-card"><small><small>R$ <?php echo @$total_saidas ?></small></small><p> 
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card-body ">
							...
							<div class="col-7 col-md-8">
								<div class="numbers">
									...
									<p class="subtitulo-card"><small><small>R$ <?php echo @$total ?></small></small><p> 
									</div>
								</div>
							</div>
						</div>
