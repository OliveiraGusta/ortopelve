...
$turno = $_POST['turno'];
	...
	//VERIFICAR SE O Profissional JÁ ESTÁ CADASTRADO
$res_c = $pdo->query("select * from medicos where cpf = '$cpf'");
$dados_c = $res_c->fetchAll(PDO::FETCH_ASSOC);
$linhas = count($dados_c);
if($linhas == 0){
	$res = $pdo->prepare("INSERT into medicos (nome, especialidade, crm, cpf, telefone, email, turno, new) values (:nome, :especialidade, :crm, :cpf, :telefone, :email, :turno, :new) ");
	...
	echo "Este Profissional já está cadastrado!!";
}
